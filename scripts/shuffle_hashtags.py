...
tags = [
  ...
  # secondary hashtags
  'ancient knowledge education spiritual spirituality hinduism krishna lordkrishna harekrishna sanatandharma sanatani mahabharat ramayana vedas hindu wisdom india meditation yoga namaste bhagavadgitaquotes science scripture universe god creation galaxy cosmos learn learning success health healthymind mind believe faith hope peace grace pray soul',
  # optional hashtags
  'instagram insta instalike instadaily instagood lifestyle lifelessons motivationalquotes motivation life book likeaboss likefollow quotes love bookstagram bestoftheday happy kind joy goodvibes'
]

def shuffle_hashtags(tags):
    total_hashtag_limit = random.randrange(22,28)
    ...
    secondary_hashtag_limit = int((total_hashtag_limit - primary_hashtag_limit) * 0.50)
